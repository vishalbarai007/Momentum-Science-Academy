                            ...
                            {activityFeed.length === 0 ? (
                                ...
                                activityFeed.map((item, i) => (
                                    <Card key={i} className="p-4 flex items-start gap-4 border-0 shadow-sm hover:shadow-md transition-shadow">
                                        <div className={`mt-1 p-2 rounded-full shrink-0 ${item.type === "Assignment" ? "bg-blue-100 text-blue-600" : "bg-orange-100 text-orange-600"
                                            }`}>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="mt-2">
                                                <span className={`text-[10px] px-2 py-0.5 rounded-full border ${item.status === 'Published' || item.status === 'Resolved'

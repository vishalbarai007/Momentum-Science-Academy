...
const rankerData: rankerItem[] = [
  ...
  },
  {
    ...
    description: "Achieved an impressive 99.24 percentile in MHT-CET 2023, showcasing exceptional academic prowess.",
    location: "Mumbai",
  },
  {
    id: 9,
    ...
    year: "2023",
    category: "MHT-CET",
    image: "/Rankers/vishal-cet.png",
    description: "Secured a remarkable 98.23 percentile in MHT-CET 2023, reflecting consistent dedication and hard work.",
    location: "Mumbai",
  },
  {
    id: 10,
    ...
    year: "2023",
    category: "MHT-CET",
    image: "/Rankers/nitesh-cet.png",
    description: "Earned an outstanding 96.56 percentile in MHT-CET 2023, demonstrating strong subject knowledge and exam skills.",
    location: "Mumbai",
  },
  {
    id: 11,
            ...
            <>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {filteredItems.map((item, idx) => (
                  ...
                  >
                    <div className="relative h-96 bg-linear-to-br from-slate-100 to-slate-50 overflow-hidden">
                      <img
